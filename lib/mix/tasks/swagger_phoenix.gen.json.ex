defmodule Mix.Tasks.SwaggerPhoenix.Gen.Json do
  use Mix.Task
  ...
  def run(args) do
    ...
    Mix.SwaggerPhoenix.copy_from paths(), "priv/templates/phoenix.gen.json", "", binding, files
    ...
    if opts[:model] != false do
      Mix.Task.run "swagger_phoenix.gen.model", ["--instructions", instructions|args]
    else
